                ...
                <div className={"contract"}>
                    {isRUS?
                        <>
                            ...
                            <p>{"6.3. срок обработки персональных данных является неограниченным. пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив оператору уведомление посредством отправки сообщения на аккаунт в мессенджере https://telegram.org/ - https://t.me/sparklzy."}</p>
                            <p>{"7. заключительные положения"}</p>
                            <p>{"7.1. пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к оператору с помощью сообщения на аккаунт в мессенджере https://telegram.org/ - https://t.me/sparklzy."}</p>
                        ...
                        <>
                            ...
                            <p>{"6.3. Processing time for personal data is unlimited. The User may at any time withdraw his consent to the processing of personal data by notifying the Operator by sending a message to the https://telegram.org/ - https:///t messenger. me/sparklzy."}</p>
                            <p>{"7. Final provisions "}</p>
                            <p>{"7.1. The user can obtain any clarifications on the inquiries concerning the processing of his personal data by contacting To the operator using the message to the account in the message message https://telegram.org/ - https://t. me/sparklzy."}</p>
