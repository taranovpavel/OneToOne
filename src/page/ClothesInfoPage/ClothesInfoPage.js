                    ...
                    {clothes.ID===0?<NothingFoundPage/>:
                        ...
                        <SwiperComponent photos={clothes.PHOTOS} swiperClasses={"swiperBig"} imageClasses={"imageBig"} autoplay={true}/>
                            <div className={classes.text}>
                                ...
                                <p className={classes.text__secondary}>{isRUS?"Если есть дополнительные вопросы напишите в ":"If you have additional questions, write to "}<a href="https://web.telegram.org/k/#@onet00ne">{isRUS?"поддержку":"support"}</a>.</p>
